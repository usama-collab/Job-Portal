...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden bg-white text-slate-950">
      ...
      <section id="categories" className="px-5 py-24 sm:px-6"><div className="mx-auto max-w-6xl">
      ...
      <section id="how-it-works" className="bg-slate-950 px-5 py-24 text-white sm:px-6"><div className="mx-auto max-w-6xl"><div className="mx-auto max-w-2xl text-center"><p className="text-xs font-black uppercase tracking-[0.22em] text-blue-400">Simple by design</p><h2 className="mt-3 text-3xl font-black tracking-[-0.035em] sm:text-4xl">From searching to hired, minus the hassle</h2><p className="mt-4 leading-7 text-slate-400">We keep the process clear so you can focus on finding work you’ll love.</p></div>
      ...
      <section className="bg-slate-50 px-5 py-24 sm:px-6"><div className="mx-auto max-w-6xl"><SectionHeading eyebrow="Hand-picked opportunities" title="Jobs worth getting excited about" action={() => navigate("/jobs")} />
      ...
      <section className="px-5 py-24 sm:px-6"><div className="mx-auto max-w-6xl"><div className="mx-auto max-w-2xl text-center"><p className="text-xs font-black uppercase tracking-[0.22em] text-blue-600">Real career momentum</p><h2 className="mt-3 text-3xl font-black tracking-[-0.035em] sm:text-4xl">Loved by people on both sides of hiring</h2></div>
      ...
      <section className="px-5 pb-24 sm:px-6"><div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-blue-600 px-7 py-14 text-white shadow-2xl shadow-blue-200 sm:px-12 lg:px-16"><div className="absolute -right-20 -top-32 h-96 w-96 rounded-full border-[60px] border-white/10" /><div className="relative flex flex-col items-start justify-between gap-9 lg:flex-row lg:items-center"><div className="max-w-2xl"><p className="text-xs font-black uppercase tracking-[0.22em] text-blue-100">Build your team</p><h2 className="mt-3 text-3xl font-black tracking-[-0.035em] sm:text-4xl">Great people are looking for you, too.</h2><p className="mt-4 max-w-xl leading-7 text-blue-100">Share your role with motivated candidates and turn your next great hire into your team’s next big win.</p></div><div className="flex flex-wrap gap-3"><Button onClick={() => navigate("/employer/onboarding")} className="h-12 rounded-xl bg-white px-6 font-black text-blue-700 hover:bg-blue-50">Post a job <ArrowRight /></Button><button onClick={() => navigate("/jobs")} className="flex h-12 items-center gap-2 rounded-xl border border-white/25 px-5 text-sm font-bold hover:bg-white/10"><Play className="h-4 w-4 fill-white" />Explore Jobify</button></div></div></div></section>

      <footer className="bg-slate-950 px-5 pb-8 pt-16 text-slate-400 sm:px-6"><div className="mx-auto max-w-6xl"><div className="grid gap-12 border-b border-slate-800 pb-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <FooterColumn title="For employers" links={[["Post a job", "/employer/onboarding"], ["Recruiting dashboard", "/employer/dashboard"], ["How it works", "/#how-it-works"], ["Talent categories", "/#categories"]]} />
