...
class Notification(Base):
    ...
    message_id = Column(Integer, ForeignKey("messages.id", name="fk_notifications_message", ondelete="SET NULL"), index=True)
    ...
    __table_args__ = (
        CheckConstraint("type IN ('application_received', 'application_status_changed', 'application_message_received')", name="ck_notification_type"),
